...
Ми юзаємо API чату гпт та RAG бо немає часу, в нормальних умовах треба натренувати ллмку на своїх даних. Це дасть неолбхідну якість та повну конфіденційність.
