...
Відео-демки через VEO (AI):

<div align="center">
  <a href="https://youtu.be/AKYHsSzquCM">
    <img src="mq2.jpg" alt="Video Thumbnail" width="400">
  </a>
</div>

<div align="center">
  <a href="https://youtu.be/y3bsS6kGIKk">
    <img src="mq1.jpg" alt="Video Thumbnail" width="400">
  </a>
</div>
...
Даний проєкт реалізовано в умовах жорстких часових обмежень та обмеженої доступності якісних відкритих даних по енергосистемі України. Через це частина компонентів (зокрема веб-інтерфейс, інтеграція LLM та деякі симуляційні блоки) реалізовані у спрощеному або демонстраційному вигляді. Архітектура системи свідомо побудована як proof-of-concept, що демонструє коректну інженерну та наукову ідею, а не як готове до промислового впровадження рішення.

Через відсутність публічних високоякісних даних по погодинному споживанню, топології мережі та реальним аваріям в Україні, частина даних була синтезована або адаптована з іноземних джерел (зокрема EIA США) із застосуванням domain adaptation, масштабування та фізично-обґрунтованих евристик. У реальних умовах усі моделі (GNN, GRU, LLM) мають бути перенавчені на внутрішніх даних оператора енергосистеми, що суттєво підвищить точність, стабільність і довіру до результатів.

Використання LLM через зовнішній API та RAG-підхід є тимчасовим інженерним компромісом. У промисловому сценарії доцільно застосовувати власну fine-tuned LLM, навчену на внутрішніх регламентах, інструкціях та історичних інцидентах. Це забезпечить необхідний рівень конфіденційності, відтворюваності та відповідності нормативним вимогам критичної інфраструктури.

Формат виходів моделей, логіка прийняття рішень Оркестратора та інтерфейс користувача не є жорстко зафіксованими. Архітектура системи дозволяє легко адаптувати вихідні сигнали під будь-який формат - від інтеграції у SCADA/EMS/DMS системи до аналітичних панелей або рекомендаційних модулів для диспетчерів. Поточна реалізація інтерфейсу обрана виключно з міркувань швидкої демонстрації концепції в умовах обмеженого часу.

В подальшому система підключиться до апі тривог та погоди для роботи в реальному часі.
